...
export default function NextPageButton({
    ...
    return (
        <div className="bottom-0 group flex w-full justify-center border border-transparent bg-slate-600 py-2 px-4 text-sm font-medium text-white hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
            {!isLoading ? (
